    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="search-items page-content">
                ...
                <a href="{{ route('admin.product.create') }}"><button class="common-btn ms-2">Add New Product<i class="bi bi-plus-circle ms-2"></i></button></a>
            </div>
            <div class="mt-1">
                            ...
                            <div class="slid col-4 mb-4">
                                <div class="box-slid common-card float w-100">
                                    <div class="img-box" style="height: 75%;">
                                        <img style="height: 100%;" src="{{ asset("uploads/products/$item->image") }}" alt="image" class="img-fluid">
                                    </div>
