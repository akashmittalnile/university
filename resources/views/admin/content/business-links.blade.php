...
@section('heading', 'Business Links')
@section('back', route('admin.affiliate'))
@push('css')
                            ...
                            <div class="slid col-4 mb-4">
                                <div class="box-slid common-card float w-100">
                                    <div class="img-box" style="height: 75%;">
                                        <img id style="height: 100%;" src="{{ assets("uploads/content/$item->image") }}" alt="image" class="img-fluid">
                                    </div>
