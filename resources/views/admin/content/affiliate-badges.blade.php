                            ...
                            <div class="slid col-4 mb-4">
                                <div class="box-slid common-card float w-100">
                                    ...
                                    <div class="d-flex mt-4">
                                        ...
                                        <a href="javascript:void(0)"><button id="imgEditBtn" class="common-btn ms-2" data-id="{{ encrypt_decrypt('encrypt', $item->id) }}" data-img="{{ assets("uploads/badges/$item->path") }}">Edit Image</button></a>
                                    </div>
                                </div>
                            </div>
                            @empty
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    <form action="{{ route('admin.affiliate.image.save') }}" method="post" id="editImgForm" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    <form action="{{ route('admin.affiliate.image.save') }}" method="post">
                        @csrf
...
<script type="text/javascript">
    ...
    Dropzone.options.multipleImage = {
        ...
        url: "{{ route('admin.affiliate.image.upload') }}",
        removedfile: function(file) {
            var name = file.upload.filename;
            $.ajax({
                type: 'post',
                url: '{{ route("admin.affiliate.image.delete") }}',
                data: {
                    filename: name,
                    _token: "{{csrf_token()}}"
                },
