                            ...
                            <div class="slid col-4 mb-4">
                                <div class="box-slid common-card float w-100">
                                    ...
                                    <div class="d-flex mt-4">
                                        ...
                                        <a href="javascript:void(0)"><button id="imgEditBtn" class="common-btn ms-2" data-id="{{ encrypt_decrypt('encrypt', $item->id) }}" data-title="{{ $item->title }}" data-description="{{ $item->description }}" data-designation="{{ $item->designation }}" data-img="{{ $item->image }}">Edit Image</button></a>
                                    </div>
                                </div>
                            </div>
                            @empty
