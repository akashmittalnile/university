...
<main class="main-container dashboard">
    <div class="main-title d-flex align-items-center">
        <div class="page-title d-flex align-items-center">
            ...
            <h3 class="font-weight-bold black-color">Accomplishment Gallery</h3>
        </div>
                            ...
                            <div class="slid col-4 mb-4">
                                <div class="box-slid common-card float w-100">
                                    <div class="img-box" style="height: 75%;">
                                        <img style="height: 100%;" src="{{ assets("uploads/gallery/$item->path") }}" alt="image" class="img-fluid">
                                    </div>
                                    <div class="d-flex mt-4">
                                        ...
                                        <a href="javascript:void(0)"><button id="imgEditBtn" class="common-btn ms-2" data-id="{{ encrypt_decrypt('encrypt', $item->id) }}" data-img="{{ assets("uploads/gallery/$item->path") }}">Edit Image</button></a>
                                    </div>
                                </div>
                            </div>
                            @empty
