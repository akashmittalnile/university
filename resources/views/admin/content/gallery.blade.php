...
<main class="main-container dashboard">
    <div class="main-title d-flex align-items-center">
        <div class="page-title d-flex align-items-center">
            <a href="{{ route('admin.dashboard') }}"><i class="bi bi-arrow-left-circle-fill main-color me-3"></i></a>
            <h3 class="font-weight-bold black-color">Manage Accomplishment Gallery</h3>
        </div>
                            ...
                            <div class="slid col-4 mb-4">
                                <div class="box-slid common-card float w-100">
                                    <div class="img-box" style="height: 75%;">
                                        <img style="height: 100%;" src="{{ asset("uploads/gallery/$item->path") }}" alt="image" class="img-fluid">
                                    </div>
                                    <div class="d-flex mt-4">
                                        <a href="javascript:void(0)"><button class="outline-btn" data-bs-toggle="modal" onclick="$('#delete_form').attr('action','{{ route('admin.gallery.uploaded.image.delete', encrypt_decrypt('encrypt', $item->id)) }}')" data-bs-target="#deleteFile">Delete</button></a>
                                        <a href="javascript:void(0)"><button id="imgEditBtn" class="common-btn ms-2" data-id="{{ encrypt_decrypt('encrypt', $item->id) }}" data-img="{{ asset("uploads/gallery/$item->path") }}">Edit Image</button></a>
                                    </div>
                                </div>
                            </div>
                            @empty
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    <form action="{{ route('admin.gallery.save') }}" method="post" id="editImgForm" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    <form action="{{ route('admin.gallery.save') }}" method="post">
                        @csrf
...
<script type="text/javascript">
    ...
    Dropzone.options.multipleImage = {
        ...
        url: "{{ route('admin.gallery.image.upload') }}",
