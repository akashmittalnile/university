...
@section('heading', 'Edit E-Book')
@section('back', route('admin.ebooks'))
@push('css')
                        ...
                        <input type="hidden" id="redirect_url" value="{{ route('admin.ebooks') }}">
                            <div class="col-md-4">
                                <div class="mb-3 field_error">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="{{ $ebook ? $ebook->name : '' }}" aria-describedby="name" placeholder="Enter E-Book Name">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="row align-items-center">
                                    <div class="col-md-3">
                                        <div class="book-img">
                                            <img src="{{ $ebook ? assets("uploads/ebooks/$ebook->thumbnail") : assets('admin/images/logo.png') }}" alt="image" id="imageDisplay" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label black-color f-600">Description</label>
